 ...
 */
public final class Config extends AbstractConfigs
{
	...
	public static boolean ENABLE_OLY_IP_ANTIFEED;
	...
	public static boolean DEBUG_HTML_DIR;
	public static boolean DEBUG_MULTISELL_DIR;
	public static boolean DEBUG_ITEM_EQUIP;
	...
	public static double ENCHANT_CHANCE_ELEMENT_STONE_S;
	public static double ENCHANT_CHANCE_ELEMENT_STONE_S80;
	public static double ENCHANT_CHANCE_ELEMENT_STONE_S84;
	public static double ENCHANT_CHANCE_ELEMENT_CRYSTAL_S;
	public static double ENCHANT_CHANCE_ELEMENT_CRYSTAL_S80;
	public static double ENCHANT_CHANCE_ELEMENT_CRYSTAL_S84;
	public static double ENCHANT_CHANCE_ELEMENT_JEWEL_S;
	public static double ENCHANT_CHANCE_ELEMENT_JEWEL_S80;
	public static double ENCHANT_CHANCE_ELEMENT_JEWEL_S84;
	public static double ENCHANT_CHANCE_ELEMENT_ENERGY_S;
	public static double ENCHANT_CHANCE_ELEMENT_ENERGY_S80;
	public static double ENCHANT_CHANCE_ELEMENT_ENERGY_S84;
	...
	{
		Config.getInstance().loadConfigs();
	}
	...
	public void loadConfigs()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			ENCHANT_CHANCE_ELEMENT_STONE_S80 = Character.getDouble("EnchantChanceElementStoneS80", 50);
			ENCHANT_CHANCE_ELEMENT_STONE_S84 = Character.getDouble("EnchantChanceElementStoneS84", 50);
			ENCHANT_CHANCE_ELEMENT_CRYSTAL_S = Character.getDouble("EnchantChanceElementCrystalS", 30);
			ENCHANT_CHANCE_ELEMENT_CRYSTAL_S80 = Character.getDouble("EnchantChanceElementCrystalS80", 40);
			ENCHANT_CHANCE_ELEMENT_CRYSTAL_S84 = Character.getDouble("EnchantChanceElementCrystalS84", 50);
			ENCHANT_CHANCE_ELEMENT_JEWEL_S = Character.getDouble("EnchantChanceElementJewelS", 20);
			ENCHANT_CHANCE_ELEMENT_JEWEL_S80 = Character.getDouble("EnchantChanceElementJewelS80", 20);
			ENCHANT_CHANCE_ELEMENT_JEWEL_S84 = Character.getDouble("EnchantChanceElementJewelS84", 30);
			ENCHANT_CHANCE_ELEMENT_ENERGY_S = Character.getDouble("EnchantChanceElementEnergyS", 5);
			ENCHANT_CHANCE_ELEMENT_ENERGY_S80 = Character.getDouble("EnchantChanceElementEnergyS80", 10);
			ENCHANT_CHANCE_ELEMENT_ENERGY_S84 = Character.getDouble("EnchantChanceElementEnergyS84", 15);
			...
			ENABLE_OLY_IP_ANTIFEED = Olympiad.getBoolean("EnableOlyIpAntifeed", false);
			...
			DEBUG_HTML_DIR = Debug.getBoolean("DebugHtmlDir", true);
			DEBUG_MULTISELL_DIR = Debug.getBoolean("DebugMultisellDir", true);
			DEBUG_ITEM_EQUIP = Debug.getBoolean("DebugItemEquip", false);
			...
			HPH_FIXINTERVALOFHALTER = vanhalter_load.getInt("FixIntervalOfHalter", 48);
			HPH_RANDOMINTERVALOFHALTER = vanhalter_load.getInt("RandomIntervalOfHalter", 24);
